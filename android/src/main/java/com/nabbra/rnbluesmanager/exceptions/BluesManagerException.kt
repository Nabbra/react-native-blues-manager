package com.nabbra.rnbluesmanager.exceptions

import com.facebook.react.bridge.Arguments
import com.facebook.react.bridge.WritableMap

enum class BluesManagerException(val message: String) {
  ...
  fun message(vararg args: String): String {
    return args.joinToString(separator = message)
  }
